				...
				<table border="1" id="myTable" width="80%" class="table table-dark table-hover table-striped">
					...
					<tbody>
						<?php                  
							...
							echo "<td><a href='index.php?c=historiales&a=eliminar&id=".$dato["id_historial"]."' class='btn btn-danger' onclick=\"return confirm('Esta seguro de elimiar el registro?');\">Eliminar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
